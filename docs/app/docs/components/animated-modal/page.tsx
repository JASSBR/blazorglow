  ...
  return (
    <div className="max-w-3xl">
      <div className="flex items-center gap-3 mb-3">
        <span className="text-xs uppercase tracking-wider text-primary font-medium">UI</span>
        <span className="px-2 py-0.5 rounded-full bg-yellow-500/10 text-yellow-500 text-xs font-medium">Coming Soon</span>
      </div>
      <h1 className="text-4xl font-bold mb-4">Animated Modal</h1>
      <p className="text-text-muted text-lg mb-10">Modal with smooth open/close transitions. Features spring-based animations for opening and closing, backdrop blur, and customizable content area.</p>
