  ...
  return (
    <div className="max-w-3xl">
      <div className="flex items-center gap-3 mb-3">
        <span className="text-xs uppercase tracking-wider text-primary font-medium">Effects</span>
        <span className="px-2 py-0.5 rounded-full bg-yellow-500/10 text-yellow-500 text-xs font-medium">Coming Soon</span>
      </div>
      <h1 className="text-4xl font-bold mb-4">Lamp Effect</h1>
      <p className="text-text-muted text-lg mb-10">Linear-style lamp for section headers. A dramatic lighting effect that illuminates content from above, inspired by the Linear app's iconic section transitions.</p>
