  ...
  return (
    <div className="max-w-3xl">
      <div className="flex items-center gap-3 mb-3">
        <span className="text-xs uppercase tracking-wider text-primary font-medium">Scroll</span>
        <span className="px-2 py-0.5 rounded-full bg-yellow-500/10 text-yellow-500 text-xs font-medium">Coming Soon</span>
      </div>
      <h1 className="text-4xl font-bold mb-4">Tracing Beam</h1>
      <p className="text-text-muted text-lg mb-10">SVG beam that follows scroll position. A glowing line traces alongside your content as the user scrolls, perfect for timelines and long-form pages.</p>
