...
export default function SparklesPage() {
  return (
    <div className="max-w-3xl">
      ...
      <h1 className="text-4xl font-bold mb-4">Sparkles</h1>
      <p className="text-text-muted text-lg mb-10">Configurable sparkle particle overlay. Adds twinkling star-like particles that fade in and out, with full control over count, size, color, and animation speed.</p>
