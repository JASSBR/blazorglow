...
export default function ParallaxScrollPage() {
  return (
    <div className="max-w-3xl">
      ...
      <p className="text-text-muted text-lg mb-10">Depth-based scroll parallax effect. Layers move at different speeds as the user scrolls, creating an immersive sense of depth and dimension.</p>
