  ...
  return (
    <div className="max-w-3xl">
      <div className="flex items-center gap-3 mb-3">
        <span className="text-xs uppercase tracking-wider text-primary font-medium">Text</span>
        <span className="px-2 py-0.5 rounded-full bg-yellow-500/10 text-yellow-500 text-xs font-medium">Coming Soon</span>
      </div>
      <h1 className="text-4xl font-bold mb-4">Typewriter</h1>
      <p className="text-text-muted text-lg mb-10">Character-by-character typing animation. Simulates real-time typing with configurable speed, cursor blinking, and optional delete-and-retype loops.</p>
